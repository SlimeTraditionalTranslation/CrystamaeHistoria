...
public class MainFlexGroup extends FlexItemGroup {
    ...
    public void open(Player p, PlayerProfile profile, SlimefunGuideMode mode) {
        final ChestMenu chestMenu = new ChestMenu(ThemeType.MAIN.getColor() + "水晶編年史");
    ...
    private void setupPage(Player player, PlayerProfile profile, SlimefunGuideMode mode, ChestMenu menu) {
        ...
        menu.replaceExistingItem(
            ...
            ChestMenuUtils.getBackButton(
                player,
                "",
                ThemeType.PASSIVE.getColor() + Slimefun.getLocalization().getMessage(player, "guide.back.guide")
            )
        );
